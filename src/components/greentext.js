    ...
    return (
        <div id='Greentext'>
            <div className='wrapped'>
                <Fade down>
                    <h2>
                        Die Module: So individuell stellen Sie Ihre App
                        zusammen:
                    </h2>
                </Fade>
                <div className='content'>
                    <Fade>
                        <div className='infogrid'>
                            ...
                            <div className='grid-1'>
                                Pushfunktionen für eilige Meldungen
                            </div>
                            <div className='grid-1'>
                                Newsstream zur schnellen Übersicht{" "}
                            </div>
                            <div className='grid-1'>
                                Einfaches Aufrufen und Auffinden
                            </div>
                            <div className='grid-1'>
                                Abruf von umfassenden Dokumenten{" "}
                            </div>
                            <div className='grid-1'>
                            ...
                            <div className='grid-2'>
                                Schadens- und Unfallmeldungen (Fahrzeug,
                                Haltestelle, Objekte)
                            </div>
                            <div className='grid-2'>
                            ...
                            <div className='grid-2'>
                                Bestellungen: Dienstkleidung, Kantine,
                                Arbeitsunterlagen
                            </div>
                            <div className='grid-2'>
